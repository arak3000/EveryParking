...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>	
	<div class="col mx-3">
		<form action="/parkingManage/insertParkingInfo" enctype="multipart/form-data" method="post" id="parkingInfoDetailForm">
			<!-- 실질적 내용 변경 구역-->
			<div class="row">
				<!-- top title-->
			...
			<div class="row mt-4 backgroundColorwhite adminBorder borderBottom tab-content"
				...
				<div class="col">
					<div class="row mb-3">
						<div class="col ms-5 mt-5 mb-4">
							<h4 style="font-weight: bold;">Stage 2: 선택한 구역의 주차 가능 대수와 구역별 할인율을 입력해 주세요</h4>
						</div>
						<div class="row mt-3">
							<div class="col-4 px-0">
								<img class="img-fluid" src="/img/image1.png">
			...
			<div class="col">
				...
				<div class="row mt-3">
					...
					<div class="col ms-1">
						...
						<div class="row me-3 mt-3">
							...
							<div class="col">
								<input type="text" name="PARK_PRICE" placeholder="할인율 적용전 시간 당 비용을 입력해주세요." style="width: 100%;">
							</div>
						</div>
						<div class="row me-3 mt-3">
				...
				<div class="row me-4 mt-4">
					...
					<div class="col-5 text-end d-gird">
						<button type="submit" class="btn btn-outline-primary">등록 완료</button>
					</div>
				</div>
			</div>
		</div>

		...
		initPage: function(){
			...
			this.gridOption = {
					cols : [
						...
						, {title:"예약 차량", name:"CAUSE", colWidth:"10"}
						, {title:"예약 기간", name:"COST", type:"number", colWidth:"15"}
						, {title:"예약 금액", name:"DATE", type:"date", colWidth:"25", order:true}
						,
						{title : "비고", name: "DEL", colWidth:"7", filter:function(data, rowData, ridx, cidx, $this) {
